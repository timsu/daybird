defmodule Sequence do
  ...
  def stem_url do
    cond do
      Sequence.dev? -> System.get_env("STEM_URL") || "localhost:5000"
      Sequence.test? -> System.get_env("STEM_URL") || "localhost:5002"
      Sequence.dogfood? -> "dogfood.sequence.is"
      Sequence.staging? -> "staging.sequence.is"
      true -> "sequence.is"
    end
  end
