      ...
      },
      {
        ...
        action: (text, selection, pattern, lineStart) => {
          ...
          setTimeout(() => {
            ...
            this.quill.insertText(this.quill.getSelection() as any, ' ')
          }, 0)
        },
      },
      {
        ...
        action: (text, selection) => {
          ...
          setTimeout(() => {
            ...
            this.quill.insertEmbed(startIndex + 1, 'hr', true, QuillSource.USER)
            this.quill.insertText(startIndex + 2, '\n', QuillSource.SILENT)
            this.quill.setSelection((startIndex + 2) as any, QuillSource.SILENT)
          }, 0)
        },
      },
      {
